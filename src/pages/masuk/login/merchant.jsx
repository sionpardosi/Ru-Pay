    ...
    return(
        <div className="content">
            <div className="form-right">
                <div className="form">
                    <div className="rectangle">
                        <div className="isi_merchant">
                            <div className="logo">
                                <img className="logoMasukMerchant" src={Logo} alt="Logo" />
                            </div>

                            <div className="text">
                                <div className="title-text-merchant">Masuk</div>
                                <div className="sub-title-merchant">
                                ...
                                <div className="emailForm">
                                    ...
                                    <div className="accountSection">
                                        ...
                                        <div className="signUp-merchant" onClick={() => window.location.href = '/signup'}>
                                            Sign Up
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="rupay-right-merchant">
